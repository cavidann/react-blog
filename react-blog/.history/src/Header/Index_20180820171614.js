...
class Header extends Component {
  ...
  toggle(e) {
    // console.log(e.target.typeof('li').getAttribute("tabHead"))
    if(e.target.getElementsByTagName === "li"){
      console.log("this");
    }

    if(e.target.getElementsByTagName !== "li"){
    let des =   e.target.closest("li").getAttribute("tabHead");
      console.log(des);
    }
  }
  ...
  render() {
    return (
      <LeftMenu>
        ...
        <ul>
          <li className="item"  tabHead='personal' onClick={this.toggle}>
            <div style={{ width: '100%' }} >
              <Icon size={'32px'} icon={user} />
            </div>
          </li>
          <li tabHead='contact' onClick={this.toggle}>
            <div style={{ width: '100%' }}>
              <Icon size={'32px'} icon={comments} />
            </div>
          </li>
          <li tabHead='education' onClick={this.toggle}>
            <div style={{ width: '100%' }}>
              <Icon size={'32px'} icon={book} />
            </div>
          </li>
          <li tabHead='experience' onClick={this.toggle}>
            <div style={{ width: '100%' }}>
              <Icon size={'32px'} icon={blackTie} />
            </div>
          </li>
          <li tabHead='skill' onClick={this.toggle}>
            <div style={{ width: '100%' }}>
