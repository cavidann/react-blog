...
class Header extends Component {
  ...
  toggle() {
    console.log(this.getAttribute("tab-head"))
  }
  ...
  render() {
    return (
      <LeftMenu>
        ...
        <MenuHeader>
          <MenuItem tab-head='personal' onClick={this.toggle}>
            <div style={{ width: '100%' }}>
              <Icon size={'32px'} icon={user} />
            </div>
          </MenuItem>
          <MenuItem tab-head='contact' onClick={this.toggle}>
            <div style={{ width: '100%' }}>
              <Icon size={'32px'} icon={comments} />
            </div>
          </MenuItem>
          <MenuItem tab-head='education' onClick={this.toggle}>
            <div style={{ width: '100%' }}>
              <Icon size={'32px'} icon={book} />
            </div>
          </MenuItem>
          <MenuItem tab-head='experience' onClick={this.toggle}>
            <div style={{ width: '100%' }}>
              <Icon size={'32px'} icon={blackTie} />
            </div>
          </MenuItem>
          <MenuItem tab-head='skill' onClick={this.toggle}>
            <div style={{ width: '100%' }}>
